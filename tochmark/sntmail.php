...
const NOTIFICATIONS_EMAIL = "vivid_shop@mail.ru";
const TELEGRAM_TOKEN = "511959445:AAFYRBWJHjcragNmlUIrA12UcIqHwz1YJc8";
const TELEGRAM_CHAT_ID = "-253355187";
...
function sendEmail($input, $leadId, $errorFiles, $goodFiles)
{
    ...
    $subject = $input["text"]["leadId"]
        ...
        : "Заявка $leadId с сайта $siteName";
    $uid = md5(uniqid(time()));
    $body = "--$uid\r\n";
...
function sendTelegram($input, $leadId, $errorFiles, $goodFiles)
{
    ...
    $message = $input["text"]["leadId"]
        ...
        : "Новая заявка на сайте $siteName\n\nID: $leadId\n";
    foreach ($input["text"] as $name => $value) {
